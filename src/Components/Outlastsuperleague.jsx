  ...
  return (
    <section className="updown-space">
      <div className="container">
        ...
        <div className="text-center my-5 py-3 legintro ">
          <p className="text-light">{data?.outlast_league?.intro}</p>
        </div>

        <div className="row">
          <div className="col-lg-5 ">
            <div className="leg-cup2">
          ...
          <div className="col-lg-7 mt-5 pt-4 pt-lg-0 mt-lg-0">
            <div className="legstep">
              {data?.outlast_league?.structure?.map((data) => (
                <div className="legpoint2 py-3 px-3 p-md-5 py-md-4 mb-5">
                  <h4>{data?.name}</h4>
                  <p>{data?.content}</p>
                </div>
              ))}
